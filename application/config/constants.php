...
/*
|--------------------------------------------------------------------------
| Page Management Related Tables
|--------------------------------------------------------------------------
*/
define('TBL_PAGE'										, 'page_management');
...
|--------------------------------------------------------------------------
|
| These are the constant defined for the site url and redirect url 
| 1. WEBSITEURL => These should be your site url 
| 				   These is done to insert email template in fck editor
|				   Also used in Exceptions class to redirect to the site url in case of 404 error.
|
| 2. REDIRECT_URL => These should be the url you want to redirect in case of 404 error
|	
